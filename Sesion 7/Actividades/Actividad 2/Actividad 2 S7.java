...
class ClienteSeguro extends Cliente {
    public ClienteSeguro(String nombre, String apellido, String correo, String direccion, String numeroTarjeta) {
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Informacion encriptada: " + clienteSeguro1.obtenerInformacionEncriptada());
